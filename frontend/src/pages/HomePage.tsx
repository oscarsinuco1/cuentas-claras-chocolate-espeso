    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-4 animate-bounce-in">
          <div className="w-20 h-20 mx-auto rounded-2xl flex items-center justify-center" style={{ backgroundColor: '#2374E1' }}>
        ...
        <div className="card animate-slide-up stagger-1">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#2374E1' }}>
        ...
        <div className="flex items-center gap-4 animate-slide-up stagger-2">
          <div className="flex-1 h-px" style={{ backgroundColor: '#3E4042' }} />
        ...
        <div className="card animate-slide-up stagger-3">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#31A24C' }}>
